...
+ 概述
  ...
  ![02_选择器概述](.\img\02_选择器概述.png)

  ![01_选择器多路复用](.\img\01_选择器多路复用.png)
...
+ 实现步骤
  ...
  7. 如果客户端把数据传递过来了，大爷会遍历所有的延伸通道，谁准备好了，谁去接收数据
       ...
       ![03_选择器改写服务器](.\img\03_选择器改写服务器.png)
...
+ 请求头
  ...
  + 请求头名称
    ...
    ![09_请求头示例](.\img\09_请求头示例.png)

+ 小结

  ![10_请求信息小结](.\img\10_请求信息小结.png)
...
+ 响应头
  ...
  + 响应头值
    ...
    ![13_响应头示例](.\img\13_响应头示例.png)

+ 小结

  ![12_响应信息小结](.\img\12_响应信息小结.png)
